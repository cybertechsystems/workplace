...
nFilter.innerHTML=oSettings.oLanguage.sSearch+sSpace+'<input type="text" class="main-table_filter"/>';var jqFilter=$("input",nFilter);
...
var sStdMenu='<select size="1" class="main-table_length" '+sName+'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select>';
