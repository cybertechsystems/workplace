...
import com.ctech.dao.AddressDao;
import com.ctech.dao.UserDao;
import com.ctech.entity.Address;
import com.ctech.entity.User;
import com.ctech.util.Util;

/**
 * This class has been used for the implementations such as saving the user record into the database,
 * finding the user details based on a user-name/both user-name and password, checking if the 
 * user-name is already available in the database/the email id is already available in the database.
 * 
 * @author Cybertech
 *
 */
...
public class UserService implements IUserService, Serializable {
    ...
    /**
     * This method has been used for saving the user details into the database. While saving
     * the address details have been associated for the corresponding user.
     */
    @Override
    @Transactional
