...
/**
 * This class has been used for the implementations such as logging into the application,
 * validating the login credentials, saving the user into the database.
 * 
 * @author Cybertech
 *
 */
